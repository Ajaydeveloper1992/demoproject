...
export default function AddNewRestaurant() {
  ...
  useEffect(() => {
    setUserdata(session)
    if (session?.user) {
      setFormData(prev => ({ ...prev, createdBy: session.user.id })) // Set createdBy when session changes
    }
  }, [session])
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/restaurant/createrestaurants`,
        formDataToSubmit,
        {
          headers: {
      ...
      Toastify({
        text: error.response?.data?.error || 'Failed to create restaurant',
        duration: 3000,
        close: true,
        gravity: 'top',
        position: 'right',
  ...
  // Restaurant Opening Houre Code
  const initialSchedule = formData.openingHours
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {errors.businessPhone && (
                <div className="text-red-500">{errors.businessPhone}</div>
              )}{' '}
              {/* Display validation error */}
            </div>
            <div>
              <Label htmlFor="minimumOrderValue">
                Minimum Order Value (For Web Order)
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="averageOrderPrepTime">
                Average Order Prepare Time (minutes)
              </Label>
              <Input
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                id="web_kitchen_print"
                name="web_kitchen_print"
            ...
            <div className="mb-6">
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    <div className="flex items-center justify-between">
                      <Label htmlFor="cod-toggle">
                        Enable Cash on Delivery
                      </Label>
                      <Switch
                        id="cod-toggle"
                        checked={formData.paymentSettings.codEnabled}
                        onCheckedChange={checked =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={formData.paymentSettings.codInstructions}
                        onChange={e =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        id="nuvei-toggle"
                        checked={formData.paymentSettings.nuveiEnabled}
                        onCheckedChange={checked =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                              ...formData.paymentSettings,
                              nuveiEnabled: checked,
                            },
                          })
                        }
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={formData.paymentSettings.nuveiSecretKey}
                        onChange={e =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                      ...
                      <Input
                        ...
                        value={formData.paymentSettings.nuveiMerchantId}
                        onChange={e =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                              ...formData.paymentSettings,
                              nuveiMerchantId: e.target.value,
                            },
                          })
                        }
                      />
                      ...
                      <Input
                        ...
                        value={formData.paymentSettings.nuveiMerchantSiteId}
                        onChange={e =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                              ...formData.paymentSettings,
                              nuveiMerchantSiteId: e.target.value,
                            },
                          })
                        }
                      />
                      <div className="flex items-center">
                        ...
                        <Switch
                          id="mode-toggle"
                          checked={formData.paymentSettings.nuveiMode}
                          onCheckedChange={checked =>
                            setFormData({
                              ...formData,
                              paymentSettings: {
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent>
                    <div className="flex items-center justify-between">
                      <Label htmlFor="stripe-toggle">Enable Stripe</Label>
                      <Switch
                        id="stripe-toggle"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={formData.paymentSettings.stripeSecretKey}
                        onChange={e =>
                          setFormData({
                            ...formData,
                            paymentSettings: {
                      ...
                      />
                      <div className="flex items-center">
                        <Label htmlFor="stripe-mode-toggle">Live Mode</Label>
                        <Switch
                          id="stripe-mode-toggle"
                          checked={formData.paymentSettings.stripeMode}
                          onCheckedChange={checked =>
                            setFormData({
                              ...formData,
                              paymentSettings: {
          ...
          <div className="space-y-4">
            ...
            <div className="p-0 space-y-4">
              ...
              <div>
                ...
                {errors['address.state'] && (
                  <div className="text-red-500">{errors['address.state']}</div>
                )}
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    handleAddressChange({ target: { name: 'timeZone', value } })
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  value={formData.address.platformLanguage}
                  onValueChange={value =>
                    handleAddressChange({
                      target: { name: 'platformLanguage', value },
                    })
                  }
                >
                  <SelectTrigger>
            ...
            <div>
              ...
              />
              {errors.ownerEmail && (
                <div className="text-red-500">{errors.ownerEmail}</div>
              )}{' '}
              {/* Display validation error */}
            </div>
            <div>
              <Label htmlFor="openingHours">Opening Hours</Label>
              {/* <Textarea id="openingHours" name="openingHours" placeholder="Enter opening hours" onChange={handleInputChange} /> */}
              <Button
                type="button"
                  ...
                  <div className="flex items-center space-x-2" key={service}>
                    <input
                      ...
                      onChange={e => {
                        ...
                        console.log(
                          `Switch ID: ${service}, Checked: ${isChecked}`
                        )
                        setFormData(prev => ({
                          ...prev,
                          servicesOffered: {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-full sm:max-w-[600px] h-[80vh] overflow-y-auto p-4">
        ...
        <DialogFooter>
          ...
          <Button type="button" className="bg-teal-600" onClick={handleSave}>
            Save Changes
          </Button>
        </DialogFooter>
      </DialogContent>
