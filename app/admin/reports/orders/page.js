...
export default function OrderReports() {
  ...
  useEffect(() => {
      ...
      try {
        if (userId) {
          const response = await axios.get(
            `${process.env.NEXT_PUBLIC_API_BASE_URL}/reports/orderreport`,
            {
              headers: {
              ...
              params: {
                ...
                fromDate: format(date.from, 'LLL dd, y'),
                //toDate: format(date.to, "yyyy-MM-dd"),
                toDate: format(date.to, 'LLL dd, y'),
          ...
          // Process the reportData for the counter sum and chart data (same as earlier)
          ...
          setSummaryData({
            ...
            totalNetSales,
            totalItems,
            averageOrderValue: totalNetSales / totalOrders || 0,
    ...
    fetchorderreport()
  }, [date, userDetails, userdata, selectedInterval, paymentstatus])
