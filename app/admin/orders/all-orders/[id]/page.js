        ...
        <CardContent>
          <Table>
            ...
            <TableFooter>
              ...
              <TableRow className="font-bold">
                <TableCell colSpan={5} className="font-medium text-green-600">
                  Tip
                </TableCell>
                ...
                <TableRow className="font-bold">
                  ...
                  <TableCell colSpan={2} className="text-right text-red-500">
                    ...
                    {order?.orderDiscount?.type === '%'
                      ? (
                          (subtotal * order?.orderDiscount?.value) /
                          100
                        ).toFixed(2)
              ...
              {order?.totalRefund > 0 && (
                <TableRow className="font-bold text-red-500">
                  <TableCell colSpan={5}>Refunded Amount</TableCell>
                  <TableCell colSpan={2} className="text-right">
              ...
              {order?.payments?.map(payment => (
                <>
                  <TableRow
                    ...
                    className="font-bold"
                  >
                    <TableCell colSpan={5}>{payment?.method}</TableCell>
                    <TableCell colSpan={2} className="text-right">
                  ...
                  {payment?.change > 0 && (
                    ...
                    >
                      <TableCell colSpan={5}>Change</TableCell>
                      <TableCell colSpan={2} className="text-right">
